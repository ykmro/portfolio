...
situation = Situation.create!(
  ...
  scenario: "主人公のフランクは大手物流倉庫で働く中年男。たまたま要人の殺人現場に居合わせたことがきっかけで、無実の罪で投獄されてしまう。自分を陥れた謎の組織へ復讐を誓った彼は刑務所内で仲間に引き入れた囚人たちとともに脱獄計画を企て、ついに決行日を迎える。
",
...
step2.choices.create!([
  ...
  {
    body: 'Hurry up and stay quiet.',
    is_correct: false,
    feedback: '「急いで、静かにしろ。」<br>意味は正しく伝わりますが、"hurry up" はややカジュアルな響きで、家族に「早くしなさい」と言う場面でも使えるくらい、日常に溶け込んでいます。命令よりは催促のニュアンスなので、この状況では少し頼りない響きです。'
  },
  {
...
step3 = situation.steps.create!(
  step_number: 3,
  body: 'ダクトに潜り込み、痕跡も消せた。あとは医務室へ降りるだけだ。すると仲間の一人が顔に落ちてきたネズミに驚き、悲鳴をあげてしまった。<br>「落ち着け。一声でも出せば終わりだ。」と言いたい時に適切なフレーズを選びましょう。'
)
...
step4.choices.create!([
  ...
  },
  {
    ...
    is_correct: false,
    feedback: '「信じてくれ、うまくいく。動き続けろ。」<br>"Keep moving" の指示自体は適切ですが、"Trust me, this is going to work" は根拠のない楽観であり、状況の深刻さを軽く見せてしまいます。怖気付いている仲間に必要なのは励ましより、覚悟を促す言葉かもしれません。'
  },
  {
...
situation = Situation.create!(
  ...
  scenario: "国家同士の争いで使われた化学兵器によって死者がゾンビ化してしまった世界。生き残った僅かな人々は結託し、食糧を求めて街から街へと旅をする。",
...
step1 = situation.steps.create!(
  step_number: 1,
  body: '新たな街へ辿り着いた一行。廃墟となった施設にゾンビが潜んでいないのを確認したのち、元陸軍のピーターは相棒とともに周辺の探察へ出かけます。またもや変わり果てた街を目の当たりにした相棒は深いため息をついています。<br>「浮かない顔だな。どうした？」と言いたい時に適切なフレーズを選びましょう。'
)
...
step1.choices.create!([
  ...
  },
  {
    body: 'Why so serious?',
    is_correct: false,
    feedback: '映画『ダークナイト』でジョーカーが放つ伝説的な一言です。「なぜそんなに深刻なの？」「何マジになっちゃってんの？」と元々は相手を嘲るような文脈で使われるセリフですが、ゾンビだらけの世界でこれを言えるメンタルは逆に頼もしい。'
  }
])
...
step2 = situation.steps.create!(
  step_number: 2,
  body: 'しばらく探察したものの人も食料も、敵すらも見当たらず、そろそろ戻ろうかと思い始めた瞬間、拠点の施設から仲間の悲鳴が聞こえます。<br>「何かが起きたようだ。すぐ戻るぞ。」と言いたい時に適切なフレーズを選びましょう。'
)
...
step2.choices.create!([
  ...
  },
  {
    ...
    is_correct: false,
    feedback: '「なんか嫌な予感がする。」<br>『スター・ウォーズ』シリーズでジェダイたちに幾度となく繰り返される名セリフです。フォースを信じましょう。'
  }
])
...
step3.choices.create!([
  ...
  },
  {
    ...
    is_correct: false,
    feedback: '「お前らまだ十分に楽しんでないだろ？」<br>『グラディエーター』で主人公がローマのコロッセオで敵に放った一言。バトル漫画でもありがちな「まだ足りねえのか？もっと来いよ」感のあるフレーズです。ゾンビの答えはおそらく「Yes」です。'
  }
])
...
step4.choices.create!([
  ...
  },
  {
    ...
    is_correct: false,
    feedback: '「今すぐ逃げてください。これが脱出のチャンスです。」<br>意味は正確ですが、"Please" が入ると瀬戸際感がゼロになります。"This is your chance to escape" も解説口調で、大群に囲まれながら叫ぶセリフとしては間延びしすぎています。'
  },
  {
...
step3.choices.create!([
  ...
  },
  {
    ...
    is_correct: false,
    feedback: '「責任はここで止まる。」<br>トルーマン大統領が残した有名な一言です。「最終的な責任は自分が取る」という覚悟を示す表現です。本来はリーダーが責任の所在を宣言する言葉であり、宇宙ミッションへの志願というより、会議の議長が締めくくる時の一言に近いかもしれません。'
  }
])
...
step4.choices.create!([
  ...
  },
  {
    ...
    is_correct: false,
    feedback: '「ミッションを遂行します。さようなら。」<br>意味は正確ですが、"proceed to execute" "Goodbye" という無機質な語の連なりが感情的な場面とややミスマッチです。宇宙飛行士というよりプログラムが喋っているようで、地上チームは泣けません。'
  },
  {
